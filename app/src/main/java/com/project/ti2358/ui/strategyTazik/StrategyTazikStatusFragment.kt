        ...
        inner class ViewHolder(private val binding: FragmentTazikStatusItemBinding) : RecyclerView.ViewHolder(binding.root) {
            fun bind(index: Int) {
                ...
                with(binding) {
                    ...
                    val changePercent = (100 * purchase.stock.getPriceNow(volume, true)) / purchase.tazikPrice - 100
                    val changeAbsolute = purchase.stock.getPriceNow(volume, true) - purchase.tazikPrice
