...
class ScreenerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var sort = StrategyScreener.Sorting.DESCENDING
        val buttonSort = view.findViewById<Button>(R.id.buttonSort)
        buttonSort.setOnClickListener {
            adapterList.setData(strategyScreener.resort(sort))
            sort = if (sort == StrategyScreener.Sorting.DESCENDING) {
                StrategyScreener.Sorting.ASCENDING
            } else {
                StrategyScreener.Sorting.DESCENDING
            }
        }

        adapterList.setData(strategyScreener.process())
