...
@KoinApiExtension
class Strategy1728DownFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_1728_down, container, false)
    ...
    inner class Item1728RecyclerViewAdapter(
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.fragment_1728_item_down, parent, false)
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val changePercent = when (step1728) {
                ...
                Step1728.step1630to1635 -> item.changePrice1625to1632Percent
                Step1728.stepFinal -> item.changePrice1625to1632Percent
            }
            ...
            val changeAbsolute = when (step1728) {
                ...
                Step1728.step1630to1635 -> item.changePrice1625to1632Absolute
                Step1728.stepFinal -> item.changePrice1625to1632Absolute
            }

            val volume = when (step1728) {
                Step1728.step700to1200 -> item.volume700to1200
                Step1728.step700to1530 -> item.volume700to1600
                Step1728.step1630to1635 -> item.volume1625to1632
