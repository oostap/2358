...
class StrategyRocketFinishFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_rocket_finish, container, false)
...
//        )
    ...
    class ItemRocketRecyclerViewAdapter(
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.fragment_rocket_finish_item, parent, false)
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.priceView.text = "${item.stock.todayDayCandle.closingPrice} $"
