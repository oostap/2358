...
@KoinApiExtension
class StrategyTrendService : Service() {

    private val NOTIFICATION_ACTION = "event.trend"
    private val NOTIFICATION_CANCEL_ACTION = "event.trend.cancel"
    private val NOTIFICATION_CHANNEL_ID = "TREND CHANNEL NOTIFICATION"
    private val NOTIFICATION_ID = 1700115
        ...
        notificationButtonReceiver = object : BroadcastReceiver() {
            override fun onReceive(context: Context, intent: Intent) {
                ...
                if (type == NOTIFICATION_CANCEL_ACTION) {
                    ...
                    context.stopService(Intent(context, StrategyTrendService::class.java))
                }
            }
        }
