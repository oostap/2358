...
- выбрать в настройках время покупки через 5 минут (по МСК);
- выбрать бюджет 10$, изменение цены задать 0%, объёмы задать 0;
- на экране 2358 выбрать мусор;
- 'продолжить' -> 'старт';
- результат: через 5 минут купится бумага и выставится заявка на продажу с выбранным профитом.
